...
public class PriceCalculatorServiceTests
{
    ...
    public void PriceCalculatorService_WhenGoodsEmptyArray_ShouldThrow()
    {
        ...
        var goodsMock = new Mock<IGoodsRepository>(MockBehavior.Default);
        var cut = new PriceCalculatorService(options, goodsMock.Object, repositoryMock.Object);
    ...
    public void PriceCalculatorService_WhenCalcAny_ShouldSave()
    {
        ...
        var goodsMock = new Mock<IGoodsRepository>(MockBehavior.Strict);
        var cut = new PriceCalculatorService(options, goodsMock.Object, repositoryMock.Object);
        ...
        decimal expected)
    {
        ...
        var goods = new Mock<IGoodsRepository>(MockBehavior.Strict);
        var cut = new PriceCalculatorService(options, goods.Object, repositoryMock.Object);
